...
if __name__=='__main__':
	...
	arg_exlude_labels = ' '.join(args.exclude_labels)
	arg_indcued_checkpoint = './checkpoint/' + arg_checkpoint_fname + '.pth'
	cmd = ' '.join(['python', 'generate_hierarchy.py', '--method', arg.method, '--dataset', 'CIFAR10', '--exclude-labels', arg_exclude_labels,

...
def set_default_values(args):
    exclude = ['IncludeLabels', 'IncludeClasses', 'ExcludeLabels', 'ResampleLabels', 'CombineLabels',
               'CombineClasses', 'ExcludeClasses', 'FewShotLabels']
...
class CIFAR10FewShotLabels(FewShotLabelsDataset):
    ...
    def __init__(self, *args, root='./data', fewshot_labels=[], fewshot_gt_nsamples=5, 
        ...
        super().__init__(
            dataset=datasets.CIFAR10(*args, root=root, **kwargs),
            fewshot_labels=fewshot_labels, fewshot_gt_nsamples=fewshot_gt_nsamples, 
            fewshot_nsamples=fewshot_nsamples, **kwargs)